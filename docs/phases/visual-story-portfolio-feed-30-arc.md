...
- [x] Approved (round 6)
- [x] Implementation
- [x] Implementation Review (approved round 3, 2026-08-16 — round 2: canonical-key precedence before the as-of filter, cockpit stale-round wording + recapture, arbiter ruling routing split in the loop diagram)
- [ ] Complete (release **3.0.0** via PR after merge + tag — the release that completes Phase 36 ships as 3.0.0, proposal §5)
