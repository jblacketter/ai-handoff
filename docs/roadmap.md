...
- **Depends on:** Phase 42
- **Status:** ✅ Complete — plan approved round 1, impl approved round 2 (2026-08-17); PR #21 (`phase-43-cockpit-hardening`) awaiting merge; release **3.7.0** after merge (`scripts/release.py 3.7.0`, tag `v3.7.0`).
